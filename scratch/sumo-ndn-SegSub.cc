...
main(int argc, char* argv[])
{
  ...
  string trace_file_path="trace.txt";
  ...
  consumerHelper.SetPrefix(prefix_consumer); //
  consumerHelper.SetAttribute("VT1", StringValue("3.0")); 
  consumerHelper.SetAttribute("LifeTime", StringValue("60.0")); 
  if(!is_my_scheme){
    consumerHelper.SetAttribute("VT1", StringValue(fixed_timer)); 
    consumerHelper.SetAttribute("LifeTime", StringValue(fixed_timer)); 
  }
  ...
  consumerHelperMob.SetPrefix(prefix_consumer); 
  consumerHelperMob.SetAttribute("VT1", StringValue("3.0")); 
  consumerHelperMob.SetAttribute("LifeTime", StringValue("60.0")); 
  consumerHelperMob.SetAttribute("StartTimeSub", StringValue(std::to_string(app1_start_time))); 
  if(!is_my_scheme){
    consumerHelperMob.SetAttribute("VT1", StringValue(fixed_timer)); 
    consumerHelperMob.SetAttribute("LifeTime", StringValue(fixed_timer)); 
  }
  if(is_Mob){
  ...
  consumerHelper2.SetPrefix(prefix_consumer2); 
  consumerHelper2.SetAttribute("VT1", StringValue("5.0")); 
  consumerHelper2.SetAttribute("LifeTime", StringValue("90.0"));  
  if(!is_my_scheme){
    consumerHelper2.SetAttribute("VT1", StringValue(fixed_timer)); 
    consumerHelper2.SetAttribute("LifeTime", StringValue(fixed_timer)); 
  }
  ...
  ndnGlobalRoutingHelper.AddOrigins("/street10", RSU_nodes.Get(producer_id));
