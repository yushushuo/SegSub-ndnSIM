...
#ifndef NFD_DAEMON_FW_ES_DESTINATED_BEST_ROUTE_STRATEGY_HPP
#define NFD_DAEMON_FW_ES_DESTINATED_BEST_ROUTE_STRATEGY_HPP
 ...
 */
class ESDestinatedBestRouteStrategy : public Strategy
                        , public ProcessNackTraits<ESDestinatedBestRouteStrategy>
{
public:
  explicit
  ESDestinatedBestRouteStrategy(Forwarder& forwarder, const Name& name = getStrategyName());
...
NFD_PUBLIC_WITH_TESTS_ELSE_PRIVATE:
  ...
  friend ProcessNackTraits<ESDestinatedBestRouteStrategy>;

private:
  scheduler::ScopedEventId m_timeoutEvent;
  std::map<Name,int> m_data_map; // 存储name-prefix和到达data的数量
...
#endif // NFD_DAEMON_FW_ES_DESTINATED_BEST_ROUTE_STRATEGY_HPP
