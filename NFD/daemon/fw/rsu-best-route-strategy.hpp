...
#ifndef NFD_DAEMON_FW_RSU_BEST_ROUTE_STRATEGY_HPP
#define NFD_DAEMON_FW_RSU_BEST_ROUTE_STRATEGY_HPP
 ...
 */
class RSUBestRouteStrategy : public Strategy
                        , public ProcessNackTraits<RSUBestRouteStrategy>
{
public:
  explicit
  RSUBestRouteStrategy(Forwarder& forwarder, const Name& name = getStrategyName());

  static const Name&
  getStrategyName();

  void 
  prepareSendACK(const Interest& interest, Face& egress, double timer1);

  double 
  calculateVT1(const Interest& interest);
...
NFD_PUBLIC_WITH_TESTS_ELSE_PRIVATE:
  ...
  friend ProcessNackTraits<RSUBestRouteStrategy>;
};

} // namespace fw
} // namespace nfd

#endif // NFD_DAEMON_FW_RSU_BEST_ROUTE_STRATEGY_HPP
