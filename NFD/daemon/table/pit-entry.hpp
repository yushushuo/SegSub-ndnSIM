...
public: // out-record
  ...
  bool
  isSubscribeEntry(); // check if is sub-Int

  InRecordCollection::iterator
  OnlyinsertInRecord(Face& face, const Interest& interest);

  InRecordCollection::iterator
  UpdateMaxTimerOrinsertInRecord(Face& face, const Interest& interest);
